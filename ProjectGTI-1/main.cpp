...
float creditY = 700.0f; // Start di atas layar

// ==========================================
// FUNGSI GUA & LINGKUNGAN
// ==========================================
void drawCave() {
    // 1. Dinding Kiri
    glPushMatrix();
...
// membuat 6 papan dengan posisi "acak" yang kita tentukan sendiri
Bilah puzzle[6] = {
...
void display() {
    ...
    if (isGameFinished) {
        ...
        if (creditY <= 300.0f) {
            renderTextJumbo(250, 250, 0.12f, 1.5f, "Created by Kelompok 5");
